...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2023 at 08:42 AM
...
INSERT INTO `chemical` (`chemical_id`, `container`, `chemical_name`, `chemical_formula`, `description`, `expiration_date`, `date_acquired`, `status_id`, `photo`, `times_borrowed`, `date_added`) VALUES
(1, 1, 'Chemical 1', '1', '1', '2024-05-03', '2023-05-03', 1, 'BU_LOGO-removebg-preview.png', 0, '2023-05-03 14:31:54'),
(2, 1, 'Chemical 2', 'chem2', 'chem2', '2024-05-03', '2023-05-03', 1, 'Bio ERD.jpeg', 0, '2023-05-03 14:41:23');
...
INSERT INTO `chemical_inventory` (`chemical_inventory_id`, `chemical_id`, `container`, `maximum_quantity`, `available_quantity`) VALUES
(1, 1, 1, 1000, 1000),
(2, 2, 1, 1000, 1000);
...
(1, 'available', 'This means that the chemical or the equipment is/are available for use.'),
(2, 'broken', 'This means that the chemical or the equipment is/are broken.'),
(3, 'lost', 'This means that the chemical or the equipment is/are lost.'),
(4, 'borrowed', 'This means that the chemical or the equipment is/are borrowed by a borrower.');
...
--
ALTER TABLE `chemical`
  MODIFY `chemical_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `chemical_inventory`
--
ALTER TABLE `chemical_inventory`
  MODIFY `chemical_inventory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
